...
class HomeV21Tests(unittest.TestCase):
    def test_home_is_banner_plus_one_four_quadrant_grid(self):
        ...
        self.assertEqual(["news", "media", "notices", "research"], quadrants)
    ...
    def test_media_is_a_real_independent_content_type(self):
        ...
        self.assertEqual({"spring-festival-list-2024"}, media_ids)
